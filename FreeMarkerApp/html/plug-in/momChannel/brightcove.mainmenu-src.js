...
(function (TVEngine) {
    ...
    menu.TabSwitch = function () {
        ...
        if (this.currentX == enumTabPage.Home)
            ...
            $("#playlistsNav li.focused").removeClass('focused');
            $("#playlistsNav li").eq(0).addClass('focused')
            $("#playlistsNav li").eq(0).css('display', '');
            $("#playlistsNav li").eq(1).css('display', '');
            $("#playlistsNav li").eq(2).css('display', '');
            $("#playlistsNav li").eq(3).css('display', '');
            $("#playlistsNav li").eq(4).css('display', '');
            $("#playlistsNav li").eq(5).css('display', '');
            $("#playlistsNav li").eq(6).css('display', 'none');
            $("#playlistsNav li").eq(7).css('display', 'none');
            $("#playlistsNav li").eq(8).css('display', 'none');
            ...
            $("#playlistsNavWrapper").css('display', '');
            $("#playlistsNav li.focused").removeClass('focused');
            $("#playlistsNav li").eq(0).css('display', 'none');
            $("#playlistsNav li").eq(1).css('display', 'none');
            $("#playlistsNav li").eq(2).css('display', 'none');
            $("#playlistsNav li").eq(3).css('display', 'none');
            $("#playlistsNav li").eq(4).css('display', 'none');
            $("#playlistsNav li").eq(5).css('display', 'none');
            $("#playlistsNav li").eq(6).css('display', '');
            $("#playlistsNav li").eq(6).addClass('focused');
            $("#playlistsNav li").eq(7).css('display', '');
            $("#playlistsNav li").eq(8).css('display', '');
            $("#TabPage_NursingPlan").css('display', "");
            //右方控制項初始化
            this.currentY = 6;
            //右側控制項移動動畫
            $("#playlistsNav").animate({
                top: -((this.currentY - 6) * $("#playlistsNav li:first").outerHeight(true))
            }, null, null);
