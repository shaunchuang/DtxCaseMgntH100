		...
		<div class="custom-blk">
			...
			<div class="col-md-12 sub-bar">
				...
				<div class="col-md-12 module-list">
					<div class="module-blk active" data-src="/ftl/imas/admin/other/phraseMgnt">
...
function viewPhraseDetail(targetId){
	window.location = "/ftl/imas/admin/other/phraseMgnt/detail/" + targetId;
}

//前往新增片語頁面
function addView(){
	window.location = "/ftl/imas/admin/other/phraseMgnt/new";
}
