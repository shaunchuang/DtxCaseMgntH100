					...
					<div class="table-blk">
						<div class="table-header">
							...
							<div class="order-temp form-inline pull-right">
								...
								<button onclick="addView()"><i class="fa fa-plus"></i>新增預約</button>					
							</div>
							<div class="clearfix"></div>
						</div>	
...
function showAppointmentList(){
	...
	newAjaxSearchTable('.main-table', $(".displaynum").val(), "${base}/division/api/fhir/appointment/list", queryData, columnObj, page_info);
}
...
function addView(){
	window.location = "${base}/${__lang}/division/web/exchange/fhir/appointment/create";
}
