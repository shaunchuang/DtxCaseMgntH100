					...
					<tr class="hb-color highlight">
						...
						<td colspan="3">
							<div class="input-group search-group">																		
								<span class="input-group-addon">ImagingStudyID</span>
								<input type="text" class="form-control s-id" aria-describedby="basic-addon1">
								<span class="input-group-addon">身份證字號</span>
								<input type="text" class="form-control s-identifier" aria-describedby="basic-addon1">
								<span class="input-group-addon">姓名</span>
								<input type="text" class="form-control s-name" aria-describedby="basic-addon1">
								<span class="input-group-addon">所屬組織</span>
								<input type="text" class="form-control s-orgnization" aria-describedby="basic-addon1">
