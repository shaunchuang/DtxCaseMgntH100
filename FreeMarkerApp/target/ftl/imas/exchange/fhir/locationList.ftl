						...
						<table class="table table-striped table-bordered bootstrap-datatable table-customed main-table">
							<thead>
						      <tr class="tablesorter-headerRow">
						      	<th width="15%">地點流水號</th>					      	
						      	<th width="10%">地點名</th>  
						      	<th width="10%">郵遞區號</th>  
						        <th width="10%">城市</th>
						        <th width="10%">區/鄉/鎮</th>
						        <th width="20%">地址</th>
...
function showLocationList(){
	...
	newAjaxSearchTable('.main-table', $(".displaynum").val(), "${base}/division/api/fhir/location/list", queryData, columnObj, page_info);
}
...
function addView(){
	window.location = "${base}/${__lang}/division/web/exchange/fhir/location/create";
}
