	...
	<script type="text/javascript">
		function changePage(formId, pageNumber) {
			...
			if(typeof pageIdentifier != 'undefined' && pageIdentifier === "ADMIN"){
				...
				wg.template.submitForm(formId, 'listForm');
			}	
		}
...
<#macro en_pagingnavigator page="" form_id="" >
	<style type="text/css">
	/* 分頁欄樣式 */
	div.pagger {
		PADDING-RIGHT: 3px;
	...
	<div class="pagger">
		<#if ((page.getPageNo()) > 1)>
			<span><a href="javascript:changePage('${form_id}', 1);">First</a></span>
			<span><a href="javascript:changePage('${form_id}', ${page.getPageNo() - 1});">Previous</a></span>
		<#else>
		...
		<#if (page.getPageNo() < page.getTotalPages())>
			<span><a href="javascript:changePage('${form_id}', ${page.getPageNo() + 1});">Next</a></span>
			<span><a href="javascript:changePage('${form_id}', ${page.getTotalPages()});">Last</a></span>
		<#else>
			<span class="disabled">Next</span>
			<span class="disabled">Last</span>
		</#if>
		<span>total ${page.getTotalCount()} records,Page</span>
		<input type="text" class="textinput" style="width:3em;" name="goPageNumber" value="${page.getPageNo()}"/>
		<span>/${page.getTotalPages()} <a href="javascript:changePageCustom('${form_id}');">GO</a></span>
	</div>
	<script type="text/javascript">
		function changePage(formId, pageNumber) {
			if (pageNumber < 1) {
