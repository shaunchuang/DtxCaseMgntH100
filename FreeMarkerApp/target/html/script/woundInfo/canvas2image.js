...
var Canvas2Image = function () {
	 ...
	 */
	var saveAsImage = function (canvas, fileName, type, width, height) {
		console.log("存圖變數：" + width + "," + height + "," + type + "," + fileName);
	...
	return {
		...
		saveAsPNG: function (canvas, fileName, width, height) {
			return saveAsImage(canvas, fileName, 'png', width, height);
		},
		saveAsJPEG: function (canvas, fileName, width, height) {
			return saveAsImage(canvas, fileName, 'jpeg', width, height);			
		},
		saveAsGIF: function (canvas, fileName, width, height) {
			return saveAsImage(canvas, fileName, 'gif', width, height)		   
		},
		saveAsBMP: function (canvas, fileName, width, height) {
			return saveAsImage(canvas, fileName, 'bmp', width, height);		   
		},
