		...
		<div class="login-blk">
			<div class="login-box">
		      	<div class="login-box-body">
		        	<p class="login-box-title" >「FHIR授權與交換平台」要求存取您的智慧醫療平台帳戶</p>
		        	<p class="login-box-msg">kitty152320</p>       
			        
			        <form action="${base}/doSecurity" method="post" class="mlog-form">
						<div>如果授予此項存取權，「FHIR授權與交換平台」將可執行以下操作</div>
				        <div>存取使用者個人資訊(如姓名、醫事機構代碼、科別、使用者角色等)</div>  
			          	
			          	<div class="row">
			          		<div class="col-xs-6 col-md-6 pd-l-0">
			          			<button class="btn btn-primary btn-flat">取消</button>
		          			</div>
		          			<div class="col-xs-6 col-md-6 pd-r-0">
			          			<button type="submit" class="btn btn-primary btn-flat" onclick="securityLogin()">同意</button>
			          		</div>			
			          	</div>
			        </form>       
		      	</div><!-- /.form-box -->
