		...
		<div class="custom-blk">
			...
			<div class="col-md-12 sub-bar">
				...
				<div class="col-md-12 module-list">
					...
					<div class="module-blk active" data-src="${__lang}/division/web/admin/other/deviceMgnt">
						<i class="fa fa-id-card fa-lg"></i>
						<span><@spring.message "admin.menu.deviceMgnt"/></span>
					</div>
					<div class="module-blk" data-src="${__lang}/division/web/admin/other/lessonMgnt">
